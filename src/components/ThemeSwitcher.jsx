...
export default function ThemeSwitcher() {
  ...
  return (
    ...
    <div className="fixed bottom-6 right-6 z-50">
      {/* The Floating Theme List (Always Rendered, Visibility Controlled) */}
      <div
        id="theme-list"
        className={`mb-3 p-3 bg-white/90 backdrop-blur-md rounded-xl shadow-2xl border border-gray-200 flex flex-col space-y-3 origin-bottom-right transition-all duration-300 ease-in-out   
          ${
            isOpen
